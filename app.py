...
def check_password():
    ...
    <div style="text-align: center; padding: 60px 20px;">
        <h1 style="color: {FL_BLUE}; font-size: 3rem; margin-bottom: 10px;">VERA-FL</h1>
        <p style="color: #666; font-size: 1.1rem; margin-bottom: 40px;">
            Verification Engine for Results & Accountability<br>Florida Implementation
        </p>
    </div>
    ...
    with col2:
        ...
        if st.button("Access VERA-FL", use_container_width=True):
    ...
    <div style="text-align: center; margin-top: 60px; color: #999; font-size: 0.85rem;">
        <p>VERA-FL analyzes FAST and ACCESS for ELLs data to identify Type 4 dyslexia candidates.</p>
